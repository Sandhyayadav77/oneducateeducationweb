...
const Main = () => {
  return (
    <>
        ...
        <div className="book-img  max-w-[70%] hidden  md:block pt-[50px] px-[15px] ">
                <img src={book} className='max-h-[80%] shadow-lg rounded-md ' alt="Book" />
            </div>
            <div className="content-panel md:relative md:mr-[40px] ">
            <div className="inner-content lg:ml-[-250px] flex justify-start items-start flex-col">
            <p className='w-full text-[2em] font-light leading-tight font-sans text-black md:text-[1.4em] md:mt-9 lg:text-[1.9em] '>Unlease the power of thought with our <br /> wide range of</p>
